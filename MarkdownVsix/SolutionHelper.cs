...
{
    /// <summary>A static helper class for working with the solution.</summary>
    internal static class SolutionHelper
    {
        /// <summary>Gets an enumerable set of all items of the specified type within the solution.</summary>
        ...
        /// <summary>
        /// Gets items of the specified type recursively from the specified parent item. Includes the
        /// parent item if it matches the specified type as well.
        /// </summary>
        /// <typeparam name="T">The type of item to retrieve.</typeparam>
        ...
        /// <summary>Gets an enumerable set of the selected project items.</summary>
        /// <param name="package">The hosting package.</param>
        /// <returns>The enumerable set of selected project items.</returns>
        internal static IEnumerable<ProjectItem> GetSelectedProjectItemsRecursively(GenerateMarkdownPackage package)
        {
        ...
        internal static IEnumerable<ProjectItem> GetSimilarProjectItems(GenerateMarkdownPackage package, ProjectItem projectItem)
        {
            var allItems = GetAllItemsInSolution<ProjectItem>(package.IDE.Solution);

            return allItems
                .Where(x => x.Name == projectItem.Name && x.Kind == projectItem.Kind && x.Document.FullName == projectItem.Document.FullName);
        }

        /// <summary>Gets the children of the specified parent item if applicable.</summary>
        /// <param name="parentItem">The parent item.</param>
